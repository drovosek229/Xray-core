...
type OutboundStatus struct {
	...
	// @Document The last runtime failure time for this outbound.
	// @Type time.ms
	LastFailureTime int64 `protobuf:"varint,8,opt,name=last_failure_time,json=lastFailureTime,proto3" json:"last_failure_time,omitempty"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
func (x *OutboundStatus) GetLastFailureTime() int64 {
	if x != nil {
...
const file_app_observatory_config_proto_rawDesc = "" +
	...
	"\x03min\x18\x06 \x01(\x03R\x03min\"\xda\x02\n" +
	...
	"healthPing\x12*\n" +
	"\x11last_failure_time\x18\b \x01(\x03R\x0flastFailureTime\"e\n" +
	...
	"\x12enable_concurrency\x18\x05 \x01(\bR\x11enableConcurrencyBe\n" +
	"\x18com.xray.app.observatoryP\x01Z0github.com/drovosek229/Xray-core/app/observatory\xaa\x02\x14Xray.App.Observatoryb\x06proto3"
