...
type Config struct {
	...
	RuntimeFailure  *RuntimeFailureConfig `protobuf:"bytes,4,opt,name=runtime_failure,json=runtimeFailure,proto3" json:"runtime_failure,omitempty"`
...
func (x *Config) GetRuntimeFailure() *RuntimeFailureConfig {
	if x != nil {
...
type RuntimeFailureConfig struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// base ejection duration after a runtime request failure, int64 values of time.Duration
	BaseBackoff int64 `protobuf:"varint,1,opt,name=base_backoff,json=baseBackoff,proto3" json:"base_backoff,omitempty"`
	// maximum ejection duration for repeated runtime failures, int64 values of time.Duration
	MaxBackoff    int64 `protobuf:"varint,2,opt,name=max_backoff,json=maxBackoff,proto3" json:"max_backoff,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *RuntimeFailureConfig) Reset() {
	*x = RuntimeFailureConfig{}
	mi := &file_app_observatory_burst_config_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *RuntimeFailureConfig) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RuntimeFailureConfig) ProtoMessage() {}

func (x *RuntimeFailureConfig) ProtoReflect() protoreflect.Message {
	mi := &file_app_observatory_burst_config_proto_msgTypes[2]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use RuntimeFailureConfig.ProtoReflect.Descriptor instead.
func (*RuntimeFailureConfig) Descriptor() ([]byte, []int) {
	return file_app_observatory_burst_config_proto_rawDescGZIP(), []int{2}
}

func (x *RuntimeFailureConfig) GetBaseBackoff() int64 {
	if x != nil {
...
func (x *RuntimeFailureConfig) GetMaxBackoff() int64 {
	if x != nil {
		return x.MaxBackoff
	}
	return 0
...
const file_app_observatory_burst_config_proto_rawDesc = "" +
	"\n" +
	"\"app/observatory/burst/config.proto\x12\x1fxray.core.app.observatory.burst\"\xe7\x01\n" +
	"\x06Config\x12)\n" +
	...
	"pingConfig\x12^\n" +
	"\x0fruntime_failure\x18\x04 \x01(\v25.xray.core.app.observatory.burst.RuntimeFailureConfigR\x0eruntimeFailure\"\xd4\x01\n" +
...
var file_app_observatory_burst_config_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_app_observatory_burst_config_proto_goTypes = []any{
	...
	(*RuntimeFailureConfig)(nil), // 2: xray.core.app.observatory.burst.RuntimeFailureConfig
}
var file_app_observatory_burst_config_proto_depIdxs = []int32{
	...
	2, // 1: xray.core.app.observatory.burst.Config.runtime_failure:type_name -> xray.core.app.observatory.burst.RuntimeFailureConfig
