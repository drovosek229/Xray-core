...
type StrategyLeastLoadConfig struct {
	...
	// minimum burst samples before a candidate can displace the current healthy winner
	MinSamples int32 `protobuf:"varint,7,opt,name=minSamples,proto3" json:"minSamples,omitempty"`
	// consecutive soft-fail cycles allowed for the current healthy winner
	SoftFailGrace int32 `protobuf:"varint,8,opt,name=softFailGrace,proto3" json:"softFailGrace,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *StrategyLeastLoadConfig) GetMinSamples() int32 {
	if x != nil {
		return x.MinSamples
	}
	return 0
...
func (x *StrategyLeastLoadConfig) GetSoftFailGrace() int32 {
	if x != nil {
		return x.SoftFailGrace
	}
	return 0
}
...
type StrategyMostStableConfig struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// weight settings
	Costs []*StrategyWeight `protobuf:"bytes,1,rep,name=costs,proto3" json:"costs,omitempty"`
	// max acceptable rtt, filter away high delay nodes. default 0
	MaxRTT int64 `protobuf:"varint,2,opt,name=maxRTT,proto3" json:"maxRTT,omitempty"`
	// acceptable failure rate. default 0.2
	Tolerance float32 `protobuf:"fixed32,3,opt,name=tolerance,proto3" json:"tolerance,omitempty"`
	// minimum burst samples before a challenger can replace a healthy winner. default 4
	MinSamples int32 `protobuf:"varint,4,opt,name=minSamples,proto3" json:"minSamples,omitempty"`
	// quarantine duration after runtime or observed failures. default 30s
	HoldDown int64 `protobuf:"varint,5,opt,name=holdDown,proto3" json:"holdDown,omitempty"`
	// successful observation cycles required after hold-down before re-entry. default 2
	RecoveryObservations int32 `protobuf:"varint,6,opt,name=recoveryObservations,proto3" json:"recoveryObservations,omitempty"`
	unknownFields        protoimpl.UnknownFields
	sizeCache            protoimpl.SizeCache
}

func (x *StrategyMostStableConfig) Reset() {
	*x = StrategyMostStableConfig{}
	mi := &file_app_router_config_proto_msgTypes[11]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *StrategyMostStableConfig) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*StrategyMostStableConfig) ProtoMessage() {}

func (x *StrategyMostStableConfig) ProtoReflect() protoreflect.Message {
	mi := &file_app_router_config_proto_msgTypes[11]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use StrategyMostStableConfig.ProtoReflect.Descriptor instead.
func (*StrategyMostStableConfig) Descriptor() ([]byte, []int) {
	return file_app_router_config_proto_rawDescGZIP(), []int{11}
}

func (x *StrategyMostStableConfig) GetCosts() []*StrategyWeight {
	if x != nil {
		return x.Costs
	}
	return nil
...
func (x *StrategyMostStableConfig) GetMaxRTT() int64 {
	if x != nil {
		return x.MaxRTT
	}
	return 0
...
func (x *StrategyMostStableConfig) GetTolerance() float32 {
	if x != nil {
		return x.Tolerance
	}
	return 0
...
func (x *StrategyMostStableConfig) GetMinSamples() int32 {
	if x != nil {
		return x.MinSamples
	}
	return 0
...
func (x *StrategyMostStableConfig) GetHoldDown() int64 {
	if x != nil {
		return x.HoldDown
	}
	return 0
...
func (x *StrategyMostStableConfig) GetRecoveryObservations() int32 {
	if x != nil {
		return x.RecoveryObservations
	}
	return 0
}
...
const file_app_router_config_proto_rawDesc = "" +
	...
	"\x05value\x18\x03 \x01(\x02R\x05value\"\x86\x02\n" +
	...
	"\ttolerance\x18\x06 \x01(\x02R\ttolerance\x12\x1e\n" +
	"\n" +
	"minSamples\x18\a \x01(\x05R\n" +
	"minSamples\x12$\n" +
	"\rsoftFailGrace\x18\b \x01(\x05R\rsoftFailGrace\"\xf7\x01\n" +
	"\x18StrategyMostStableConfig\x125\n" +
	"\x05costs\x18\x01 \x03(\v2\x1f.xray.app.router.StrategyWeightR\x05costs\x12\x16\n" +
	"\x06maxRTT\x18\x02 \x01(\x03R\x06maxRTT\x12\x1c\n" +
	"\ttolerance\x18\x03 \x01(\x02R\ttolerance\x12\x1e\n" +
	"\n" +
	"minSamples\x18\x04 \x01(\x05R\n" +
	"minSamples\x12\x1a\n" +
	"\bholdDown\x18\x05 \x01(\x03R\bholdDown\x122\n" +
	"\x14recoveryObservations\x18\x06 \x01(\x05R\x14recoveryObservations\"\x90\x02\n" +
	"\x06Config\x12O\n" +
	...
	"\n" +
	"IpOnDemand\x10\x03BV\n" +
	"\x13com.xray.app.routerP\x01Z+github.com/drovosek229/Xray-core/app/router\xaa\x02\x0fXray.App.Routerb\x06proto3"
...
var file_app_router_config_proto_msgTypes = make([]protoimpl.MessageInfo, 16)
var file_app_router_config_proto_goTypes = []any{
	...
	(*StrategyMostStableConfig)(nil), // 13: xray.app.router.StrategyMostStableConfig
	(*Config)(nil),                   // 14: xray.app.router.Config
	(*Domain_Attribute)(nil),         // 15: xray.app.router.Domain.Attribute
	nil,                              // 16: xray.app.router.RoutingRule.AttributesEntry
	nil,                              // 17: xray.app.router.WebhookConfig.HeadersEntry
	(*net.PortList)(nil),             // 18: xray.common.net.PortList
...
var file_app_router_config_proto_depIdxs = []int32{
	...
	15, // 1: xray.app.router.Domain.attribute:type_name -> xray.app.router.Domain.Attribute
	...
	18, // 8: xray.app.router.RoutingRule.port_list:type_name -> xray.common.net.PortList
	19, // 9: xray.app.router.RoutingRule.networks:type_name -> xray.common.net.Network
	4,  // 10: xray.app.router.RoutingRule.source_geoip:type_name -> xray.app.router.GeoIP
	18, // 11: xray.app.router.RoutingRule.source_port_list:type_name -> xray.common.net.PortList
	16, // 12: xray.app.router.RoutingRule.attributes:type_name -> xray.app.router.RoutingRule.AttributesEntry
	4,  // 13: xray.app.router.RoutingRule.local_geoip:type_name -> xray.app.router.GeoIP
	18, // 14: xray.app.router.RoutingRule.local_port_list:type_name -> xray.common.net.PortList
	18, // 15: xray.app.router.RoutingRule.vless_route_list:type_name -> xray.common.net.PortList
	9,  // 16: xray.app.router.RoutingRule.webhook:type_name -> xray.app.router.WebhookConfig
	17, // 17: xray.app.router.WebhookConfig.headers:type_name -> xray.app.router.WebhookConfig.HeadersEntry
	20, // 18: xray.app.router.BalancingRule.strategy_settings:type_name -> xray.common.serial.TypedMessage
	11, // 19: xray.app.router.StrategyLeastLoadConfig.costs:type_name -> xray.app.router.StrategyWeight
	11, // 20: xray.app.router.StrategyMostStableConfig.costs:type_name -> xray.app.router.StrategyWeight
	1,  // 21: xray.app.router.Config.domain_strategy:type_name -> xray.app.router.Config.DomainStrategy
	8,  // 22: xray.app.router.Config.rule:type_name -> xray.app.router.RoutingRule
	10, // 23: xray.app.router.Config.balancing_rule:type_name -> xray.app.router.BalancingRule
