...
type RetryReplayPolicy int32

const (
	RetryReplayPolicy_ZERO_BYTE_ONLY         RetryReplayPolicy = 0
	RetryReplayPolicy_LEGACY_CONSUMED_BENIGN RetryReplayPolicy = 1
)

// Enum value maps for RetryReplayPolicy.
var (
	RetryReplayPolicy_name = map[int32]string{
		0: "ZERO_BYTE_ONLY",
		1: "LEGACY_CONSUMED_BENIGN",
	}
	RetryReplayPolicy_value = map[string]int32{
		"ZERO_BYTE_ONLY":         0,
		"LEGACY_CONSUMED_BENIGN": 1,
	}
)

func (x RetryReplayPolicy) Enum() *RetryReplayPolicy {
	p := new(RetryReplayPolicy)
	*p = x
	return p
}

func (x RetryReplayPolicy) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (RetryReplayPolicy) Descriptor() protoreflect.EnumDescriptor {
	return file_app_proxyman_config_proto_enumTypes[0].Descriptor()
}

func (RetryReplayPolicy) Type() protoreflect.EnumType {
	return &file_app_proxyman_config_proto_enumTypes[0]
}

func (x RetryReplayPolicy) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use RetryReplayPolicy.Descriptor instead.
func (RetryReplayPolicy) EnumDescriptor() ([]byte, []int) {
...
type SenderConfig struct {
	...
	RetryReplayPolicy RetryReplayPolicy       `protobuf:"varint,7,opt,name=retry_replay_policy,json=retryReplayPolicy,proto3,enum=xray.app.proxyman.RetryReplayPolicy" json:"retry_replay_policy,omitempty"`
	unknownFields     protoimpl.UnknownFields
	sizeCache         protoimpl.SizeCache
}
...
func (x *SenderConfig) GetRetryReplayPolicy() RetryReplayPolicy {
	if x != nil {
		return x.RetryReplayPolicy
	}
	return RetryReplayPolicy_ZERO_BYTE_ONLY
}
...
const file_app_proxyman_config_proto_rawDesc = "" +
	...
	"\x0ftarget_strategy\x18\x06 \x01(\x0e2'.xray.transport.internet.DomainStrategyR\x0etargetStrategy\x12T\n" +
	"\x13retry_replay_policy\x18\a \x01(\x0e2$.xray.app.proxyman.RetryReplayPolicyR\x11retryReplayPolicy\"\xa4\x01\n" +
...
var file_app_proxyman_config_proto_goTypes = []any{
	(RetryReplayPolicy)(0),        // 0: xray.app.proxyman.RetryReplayPolicy
...
var file_app_proxyman_config_proto_depIdxs = []int32{
	8,  // 0: xray.app.proxyman.ReceiverConfig.port_list:type_name -> xray.common.net.PortList
	9,  // 1: xray.app.proxyman.ReceiverConfig.listen:type_name -> xray.common.net.IPOrDomain
	10, // 2: xray.app.proxyman.ReceiverConfig.stream_settings:type_name -> xray.transport.internet.StreamConfig
	2,  // 3: xray.app.proxyman.ReceiverConfig.sniffing_settings:type_name -> xray.app.proxyman.SniffingConfig
	11, // 4: xray.app.proxyman.InboundHandlerConfig.receiver_settings:type_name -> xray.common.serial.TypedMessage
	11, // 5: xray.app.proxyman.InboundHandlerConfig.proxy_settings:type_name -> xray.common.serial.TypedMessage
	9,  // 6: xray.app.proxyman.SenderConfig.via:type_name -> xray.common.net.IPOrDomain
	10, // 7: xray.app.proxyman.SenderConfig.stream_settings:type_name -> xray.transport.internet.StreamConfig
	12, // 8: xray.app.proxyman.SenderConfig.proxy_settings:type_name -> xray.transport.internet.ProxyConfig
	7,  // 9: xray.app.proxyman.SenderConfig.multiplex_settings:type_name -> xray.app.proxyman.MultiplexingConfig
	13, // 10: xray.app.proxyman.SenderConfig.target_strategy:type_name -> xray.transport.internet.DomainStrategy
	0,  // 11: xray.app.proxyman.SenderConfig.retry_replay_policy:type_name -> xray.app.proxyman.RetryReplayPolicy
