...
type XmuxConfig struct {
	...
	WarmConnections  int32                  `protobuf:"varint,7,opt,name=warmConnections,proto3" json:"warmConnections,omitempty"`
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
func (x *XmuxConfig) GetWarmConnections() int32 {
	if x != nil {
		return x.WarmConnections
	}
	return 0
}
...
type Config struct {
	...
	BehaviorProfile        string                 `protobuf:"bytes,28,opt,name=behaviorProfile,proto3" json:"behaviorProfile,omitempty"`
	SessionOpenTimeoutSecs int64                  `protobuf:"varint,29,opt,name=sessionOpenTimeoutSecs,proto3" json:"sessionOpenTimeoutSecs,omitempty"`
	SessionIdleTimeoutSecs int64                  `protobuf:"varint,30,opt,name=sessionIdleTimeoutSecs,proto3" json:"sessionIdleTimeoutSecs,omitempty"`
	unknownFields          protoimpl.UnknownFields
	sizeCache              protoimpl.SizeCache
}
...
func (x *Config) GetBehaviorProfile() string {
	if x != nil {
...
func (x *Config) GetSessionOpenTimeoutSecs() int64 {
	if x != nil {
		return x.SessionOpenTimeoutSecs
	}
	return 0
}

func (x *Config) GetSessionIdleTimeoutSecs() int64 {
	if x != nil {
		return x.SessionIdleTimeoutSecs
	}
	return 0
}
...
const file_transport_internet_splithttp_config_proto_rawDesc = "" +
	...
	"\x02to\x18\x02 \x01(\x05R\x02to\"\xa2\x04\n" +
	"\n" +
	"XmuxConfig\x12V\n" +
	...
	"\x10hKeepAlivePeriod\x18\x06 \x01(\x03R\x10hKeepAlivePeriod\x12(\n" +
	"\x0fwarmConnections\x18\a \x01(\x05R\x0fwarmConnections\"\xdc\f\n" +
	"\x06Config\x12\x12\n" +
	...
	"\x0fbehaviorProfile\x18\x1c \x01(\tR\x0fbehaviorProfile\x126\n" +
	"\x16sessionOpenTimeoutSecs\x18\x1d \x01(\x03R\x16sessionOpenTimeoutSecs\x126\n" +
	"\x16sessionIdleTimeoutSecs\x18\x1e \x01(\x03R\x16sessionIdleTimeoutSecs\x1a:\n" +
	"\fHeadersEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01B\x8c\x01\n" +
	"%com.xray.transport.internet.splithttpP\x01Z=github.com/drovosek229/Xray-core/transport/internet/splithttp\xaa\x02!Xray.Transport.Internet.SplitHttpb\x06proto3"
