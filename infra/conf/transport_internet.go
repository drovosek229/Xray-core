...
import (
	...
	"github.com/drovosek229/Xray-core/transport/internet/finalmask/fragment"
	"github.com/drovosek229/Xray-core/transport/internet/finalmask/header/custom"
	"github.com/drovosek229/Xray-core/transport/internet/finalmask/header/dns"
	"github.com/drovosek229/Xray-core/transport/internet/finalmask/header/dtls"
	"github.com/drovosek229/Xray-core/transport/internet/finalmask/header/srtp"
	"github.com/drovosek229/Xray-core/transport/internet/finalmask/header/utp"
	"github.com/drovosek229/Xray-core/transport/internet/finalmask/header/wechat"
	"github.com/drovosek229/Xray-core/transport/internet/finalmask/header/wireguard"
	"github.com/drovosek229/Xray-core/transport/internet/finalmask/mkcp/aes128gcm"
	"github.com/drovosek229/Xray-core/transport/internet/finalmask/mkcp/original"
	"github.com/drovosek229/Xray-core/transport/internet/finalmask/noise"
	"github.com/drovosek229/Xray-core/transport/internet/finalmask/salamander"
	finalsudoku "github.com/drovosek229/Xray-core/transport/internet/finalmask/sudoku"
	"github.com/drovosek229/Xray-core/transport/internet/finalmask/xdns"
	"github.com/drovosek229/Xray-core/transport/internet/finalmask/xicmp"
	"github.com/drovosek229/Xray-core/transport/internet/httpupgrade"
	"github.com/drovosek229/Xray-core/transport/internet/hysteria"
	"github.com/drovosek229/Xray-core/transport/internet/kcp"
	"github.com/drovosek229/Xray-core/transport/internet/reality"
	"github.com/drovosek229/Xray-core/transport/internet/splithttp"
	"github.com/drovosek229/Xray-core/transport/internet/tcp"
...
type SplitHTTPConfig struct {
	...
	SessionOpenTimeoutSecs int64             `json:"sessionOpenTimeoutSecs"`
	SessionIdleTimeoutSecs int64             `json:"sessionIdleTimeoutSecs"`
...
func (c *SplitHTTPConfig) Build() (proto.Message, error) {
	...
	switch c.BehaviorProfile {
	case "":
		c.BehaviorProfile = splithttp.BehaviorProfileLegacy
	case splithttp.BehaviorProfileLegacy, splithttp.BehaviorProfileBalanced:
	default:
		return nil, errors.New("unsupported behaviorProfile: " + c.BehaviorProfile)
	}
	...
	case "":
		if c.BehaviorProfile == splithttp.BehaviorProfileBalanced {
			c.XPaddingMethod = string(splithttp.PaddingMethodTokenish)
		} else {
			c.XPaddingMethod = string(splithttp.PaddingMethodRepeatX)
		}
	...
	if c.SessionIdleTimeoutSecs < 0 {
		return nil, errors.New("invalid negative value of sessionIdleTimeoutSecs")
	}

	if c.Xmux.MaxConnections.To > 0 && c.Xmux.MaxConcurrency.To > 0 {
		return nil, errors.New("maxConnections cannot be specified together with maxConcurrency")
	}
	if c.Xmux == (XmuxConfig{}) && c.BehaviorProfile != splithttp.BehaviorProfileBalanced {
